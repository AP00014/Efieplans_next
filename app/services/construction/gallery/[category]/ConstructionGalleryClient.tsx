...
const ConstructionGalleryClient = () => {
  const params = useParams();
  const category = params.category as string;
  const [images, setImages] = useState<ConstructionMedia[]>([]);
  ...
  useEffect(() => {
    if (category) {
      const categoryMedia = getMediaByCategory(category as ConstructionCategory);
  ...
  const categoryInfo = category ? getCategoryInfo(category as ConstructionCategory) : null;
    ...
    return (
      <div className="construction-gallery-error">
        ...
        <Link href="/services/construction" className="back-link">
          <FaArrowLeft /> Back to Construction
        </Link>
      </div>
    );
  }
  ...
  return (
    <div className="construction-gallery-page">
      ...
      <div className="construction-gallery-header">
        <Link href="/services/construction" className="gallery-back-button">
          <FaArrowLeft /> Back
        </Link>
...
export default ConstructionGalleryClient;
