...
const DesignDetailClient = () => {
  ...
  const [media, setMedia] = useState<DesignMedia | null>(null);
  const [relatedMedia, setRelatedMedia] = useState<DesignMedia[]>([]);
  ...
  if (error || !media) {
    return (
      <div className="construction-detail-error">
        ...
        <p>The requested design media could not be found.</p>
        <Link href="/services/design" className="back-link">
          <FaArrowLeft /> Back to Design Gallery
        </Link>
      </div>
    );
  }
      ...
      <div className="construction-detail-header">
        <div className="container-custom">
          <div className="detail-header-actions">
            <Link href="/services/design" className="detail-back-button">
              <FaArrowLeft /> Back
            </Link>
          </div>
        </div>
            ...
            <div className="construction-related-grid">
              {relatedMedia.map((item) => (
                <motion.div
                  ...
                  onClick={() => router.push(`/services/design/${item.id}`)}
                >
                  <OptimizedImage
